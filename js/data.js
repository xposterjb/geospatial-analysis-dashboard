...
const rawData = {
    ...
    puntiInteresse: [
        ...
        [43.7969636, 11.0856268, 'Ponte alle Palle', null],
        [43.8023238, 11.0909141, 'Primo ponte via dei Sodi', null],
        [43.8074198, 11.0954578, 'Secondo ponte via dei Sodi', null],

        // Discoteca dove Pas.Gen. lasciò la sorella.
        [43.9541819, 11.3907706, 'Discoteca Teen Club', null],

        // Locale frequentato da guardoni
        [43.7233708, 11.146381, 'Taverna Diavolo', null],

        // Due fidanzati incrociano auto rossa sportiva
        [43.8609502, 11.1551875, 'Auto rossa Ponte Torrente Marina 1981', null],

        // Abitazione dell'uomo che trovò i tedeschi
        [43.7338035, 11.2065226, 'Abit. Rol. Rei. 1983', null],
        [43.73306552, 11.20698601, 'Villa La Sfacciata', null],

        // Bar dove lavorava Pia Ron.
        [43.9337263, 11.4583901, 'Bar La Nuova Spiaggia', null],

        // Bar gestito da un testimone
        [43.9610135, 11.3564882, 'Bar Bardazzi', null],
        ...
        [43.6918710, 11.2014136, 'Tratt. Baracchina', null],

        // Festa dell'Unità di Cerbaia, dove furono visti i due turisti francesi prima dell'ultimo delitto.
        [43.6851916, 11.1317787, 'Festa Unità di Cerbaia', null],

        // Luogo da cui fu spedita la lettera alla PM SDM
        [43.95909, 11.32101, 'Poste S.Piero a Sieve', null],

        [43.66697941313906, 11.193038632792693, 'Cimitero San Casciano', null],
    ...
    abitazioniSospettati: [
        // Abitazioni sardi
        [43.7670, 11.1172, 'Casa Fra. Vin.', null],
        [43.8808, 11.0966, 'Casa Sal. Vin.', null],

        // Abitazioni CdM    
        [43.6347, 11.2328, 'Casa Pie. Pac.', null],
        [43.6546, 11.18356, 'Casa Mar. Van.', null],
        [43.6558, 11.18414, 'Casa Gia. Lot.', null],
        //[,'Casa Faggi'],
        //[43.6531, 11.1819, 'Casa Pucci'],

        // Altri
        [43.6932, 11.2070, 'Cim. Falciani', null],
        [43.8843448, 11.1028289, 'Casa Gia. Vig.', null],
        [43.9651471, 11.4654640, 'Casa Madre Gia. Vig.', null],
        [43.1283, 12.1700, 'Villa Fra. Nar.', null],
        [43.657073, 11.185923,'Casa Fra. Cal.', null],
        [43.685244, 11.191890, 'Casa Sal. Ind.', null]
    ],

    abitazioniVittime: [
        [43.7706075, 11.1117782, 'Casa Ste. Mel. - Bar. Loc.', null],

        [43.7715977, 11.1068373, 'Casa Ant. LoB.', null],
        [43.8083887, 11.0963123, 'Casa Fra. DeF.', null],

        [43.810167, 11.399329, 'Casa Pas. Gen.', null],
        [43.942676, 11.4412496, 'Casa Ste. Pet.', null],

        [43.7584008, 11.1970467, 'Casa Car. DeN.', null],
        [43.7733886, 11.4347534, 'Casa Gio. Fog.', null],

        [43.782659, 11.240787, 'Casa Sus. Cam.', null],
        [43.7816133, 11.2392434, 'Casa prov. Sus. Cam.', null],
        [43.8663673, 11.1426719, 'Casa Ste. Bal.', null],

        [43.6389567, 11.0818644, 'Casa Pao. Mai.', null],
        [43.6464069, 11.0624505, 'Casa Ant. Mig.', null],

        [43.9333951, 11.4626938, 'Casa Pia. Ron.', null],
        [43.9332041, 11.4645859, 'Casa Cla. Ste.', null]
    ]
};

const convertiInUTM = data => data.map(([lat, lon, label, desc, link1, link2]) => {
